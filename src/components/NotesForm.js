    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                <input style={{marginBottom : '10px'}} type="text" placeholder="Title" value={title} onChange={handleTitleChange} /><br/>
                <input style={{marginBottom : '10px'}} type="text" placeholder="Body" value={body} onChange={handleBodyChange} /><br/>
